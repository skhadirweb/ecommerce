...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function updatePreparation(AdminContext $context)
    {
        ...
        $mail->send($order->getUser()->getEmail(), $order->getUser()->getFirstname(), "Informations concernant votre commande", $content);
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $this->addFlash('notice', "<span style='color:orangered;'><strong>La commande ".$order->getReference()." <u>est en cours de livraison</u>.</strong></span>");
